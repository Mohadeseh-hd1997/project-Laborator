...
import ProfileSummeryCard from "../DentistProfile/ProfileSummeryCard";
import {LaboratorCard} from "../DentistProfile/LaboratorCard";

export default function ProfileGridLab(props) {
