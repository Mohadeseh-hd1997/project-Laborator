...
export default function ViewRequest(props) {
    ...
    return (
        <Box display='flex' flexDirection='column' maxWidth='140px' >
            <Box width='1282px' height='275px' textAlign='start' padding='24px' sx={{
                ...
                <Typography variant='p' sx={{ color: '#2143DD', fontWeight: 'bold', fontSize: '34px' }}>مرضیه
                    شاهرخی</Typography>
                <Box>
                    <Box sx={{
                        display: 'flex',
                    ...
                    {props.Bridge ?
                        <Box sx={{
                            ...
                            justifyContent: 'flex-start',
                            alignItems: 'center',
                            backgroundImage: 'linear-gradient(45deg, #C30000, #8A0000)'
                        }}>
                            <Box width='6px'
                                sx={{ borderRadius: '4px', backgroundColor: '#C30000', height: 'inherit' }}></Box>
                            <img src={Warning} style={{
                                marginRight: '11px',
                                padding: '8px',
                                borderRadius: '50px',
                                backgroundColor: '#a03333'
                            }} />
                            <Typography variant='p' fontSize='18px' fontWeight='700' marginRight='11px' color='#FFFFFF'>دستور
                                درمان دارای Bridge می‌باشد.</Typography>
                        </Box>
                        : ''}
                </Box>
            </Box>
            ...
            <Box sx={{ boxShadow: '10px 10px 18px 36px rgba(248,248,248,0.75)', borderRadius: '8px' }} width='1282px'
                height='469px' textAlign='start' marginTop='32px' marginBottom='47px'>
                < TeethList />

            </Box>
            <Box sx={{ boxShadow: '10px 10px 18px 36px rgba(248,248,248,0.75)', borderRadius: '8px' }} width='1282px'
                height='313px' textAlign='start' paddingX='40px' paddingY='32px'>
                <Box>
                ...
                <Box display='flex' flexDirection='row' justifyContent='space-between' marginTop='16px'>
                    <Box width='40%' display='flex' flexDirection='row' justifyContent='space-between'
                        alignItems='flex-start' paddingLeft='24px'>
                        <img src={Description} />
                        <Typography

                            sx={{ color: '#4C4C4C', marginRight: '8px' }} lineHeight='36px' fontWeight='400'
                            fontSize='18px' textalign='start'> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ
                    ...
                    <Box width='60%' borderRight='1px solid #E5E5E5' paddingY='8px' paddingRight='32px'
                        paddingLeft='10px'>
                                ...
                                {docs.map(item =>
                                    <Box>
                                        ...
                                        <Box display='flex' flexDirection='row' alignItems='center'
                                            sx={{ backgroundColor: '#E5E5E5' }} paddingX='14px' paddingY='12px'
                                            sx={{ backgroundColor: '#E5E5E5' }} paddingX='14px' paddingY='12px'
                                            marginTop='10px' height='48px' width='152px' borderRadius='8px'>
